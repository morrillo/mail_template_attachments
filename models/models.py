...
class MailTemplate(models.Model):
	...
	allow_automatic_attachments = fields.Boolean('Automatically add document attachments')
...
class MailComposer(models.TransientModel):
    ...
    def onchange_template_id(self, template_id, composition_mode, model, res_id):
        ...
        if template_id and composition_mode == 'mass_mail':
            ...
            ir_attachment_ids = self.env['ir.attachment'].search([('res_model','=',model),('res_id','=',res_id)])

            if template_id and template and template.allow_automatic_attachments:
            	for ir_attachment in ir_attachment_ids:
                	if ir_attachment.id not in attachment_ids:
